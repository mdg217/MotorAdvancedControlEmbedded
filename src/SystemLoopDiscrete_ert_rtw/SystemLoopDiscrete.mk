###########################################################################
## Makefile generated for component 'SystemLoopDiscrete'. 
## 
## Makefile     : SystemLoopDiscrete.mk
## Generated on : Wed Jun 14 11:30:56 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SystemLoopDiscrete.elf
...
PRODUCT_NAME              = SystemLoopDiscrete
MAKEFILE                  = SystemLoopDiscrete.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Marco/Desktop/GitHub/MotorAdvancedControlEmbedded/src
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = SystemLoopDiscrete_comp.rsp
CMD_FILE                  = SystemLoopDiscrete.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SystemLoopDiscrete.elf
...
DEFINES_STANDARD = -DMODEL=SystemLoopDiscrete -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/MW_digitalIO.cpp C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/MW_PWM.cpp C:/Users/Marco/Desktop/EmbeddedDigitalControllers/quadratureEncoder_module/src/soc_stm_encoder.cpp $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_mode.c $(START_DIR)/SystemLoopDiscrete_ert_rtw/SystemLoopDiscrete.c $(START_DIR)/SystemLoopDiscrete_ert_rtw/SystemLoopDiscrete_data.c $(START_DIR)/SystemLoopDiscrete_ert_rtw/rtGetInf.c $(START_DIR)/SystemLoopDiscrete_ert_rtw/rtGetNaN.c $(START_DIR)/SystemLoopDiscrete_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/common/xcp_utils.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_frame_serial.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_serial.c C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/stmnucleo/STM32F401RE/src/mw_mbed_interface.cpp C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/BufferedSerial.cpp C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/stmnucleo/src/blapp_support.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/SysTickScheduler.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/m3m4m4f_multitasking.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/xcp/src/sys_arch.c C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/xcp_platform_timer_mbed.c C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/rtiostream_serial_mbed.cpp

MAIN_SRC = $(START_DIR)/SystemLoopDiscrete_ert_rtw/ert_main.c
...
OBJS = MW_digitalIO.o MW_PWM.o soc_stm_encoder.o xcp_ext_mode.o SystemLoopDiscrete.o SystemLoopDiscrete_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o blapp_support.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
%.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_PWM.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/MW_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


soc_stm_encoder.o : C:/Users/Marco/Desktop/EmbeddedDigitalControllers/quadratureEncoder_module/src/soc_stm_encoder.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SystemLoopDiscrete.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/SystemLoopDiscrete.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SystemLoopDiscrete_data.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/SystemLoopDiscrete_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/SystemLoopDiscrete_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rtiostream_serial_mbed.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/mbed/src/rtiostream_serial_mbed.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
