###########################################################################
## Makefile generated for component 'MIL_Model_Position_Control_Kalman'. 
## 
## Makefile     : MIL_Model_Position_Control_Kalman.mk
## Generated on : Fri Jun 16 22:05:50 2023
## Final product: ./MIL_Model_Position_Control_Kalman_rtwlib.lib
...
PRODUCT_NAME              = MIL_Model_Position_Control_Kalman
MAKEFILE                  = MIL_Model_Position_Control_Kalman.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Marco/Desktop/GitHub/MotorAdvancedControlEmbedded/src/FinalVersion
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = MIL_Model_Position_Control_Kalman_comp.rsp
CMD_FILE                  = MIL_Model_Position_Control_Kalman.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = MIL_Model_Position_Control_Kalman_rtwlib.lib
...
PRODUCT = ./MIL_Model_Position_Control_Kalman_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=MIL_Model_Position_Control_Kalman -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/MIL_Model_Position_Control_Kalman/MIL_Model_Position_Control_Kalman.c
...
OBJS = MIL_Model_Position_Control_Kalman.o
...
%.o : $(START_DIR)/slprj/ert/MIL_Model_Position_Control_Kalman/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MIL_Model_Position_Control_Kalman/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MIL_Model_Position_Control_Kalman/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/MIL_Model_Position_Control_Kalman/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/MIL_Model_Position_Control_Kalman/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MIL_Model_Position_Control_Kalman.o : $(START_DIR)/slprj/ert/MIL_Model_Position_Control_Kalman/MIL_Model_Position_Control_Kalman.c
	$(CC) $(CFLAGS) -o "$@" "$<"
